...
const Collections = (props) => {
  ...
  return (
    <Col>
      ...
      <ItemList items={items} setActiveItem={setActiveItem} defaultFields={defaultFields} />
      <ItemForm activeItem={activeItem} defaultFields={defaultFields} formSubmit={formSubmit} />
    </Col>
  )
}
