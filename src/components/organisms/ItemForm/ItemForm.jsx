...
export const ItemForm = (props) => {
  const { setRenameFile, isRenameFile, renameItem, activeItem, handleFormSubmit, handleFileNameChange, fileNameError, editFileName, deleteItem, match, handleMarkdownChange, fileUploads, stagedFileUploads, setStagedFileUploads, permissions, ...rest } = props
        ...
        <div className='tab-content-card'>
          {
            item === 'new' || isRenameFile
              ...
              : <div className={'flex-row align-center'}>
                <Title title={item} className='break-word m-1' />
